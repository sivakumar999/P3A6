...
namespace BookStore.Controllers
{
    public class BooksController : Controller
    {
        ...
        {
            ViewData["CategoryId"] = new SelectList(_context.BookCategories, "Id", "Id");
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Price,CategoryId,PublisherId")] Book book)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Price,CategoryId,PublisherId")] Book book)
        {
            if (id != book.Id)
            {
                return NotFound();
